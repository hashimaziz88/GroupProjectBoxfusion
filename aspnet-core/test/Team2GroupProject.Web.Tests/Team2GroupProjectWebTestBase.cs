...
{
    public abstract class Team2GroupProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Team2GroupProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Team2GroupProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Team2GroupProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Team2GroupProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Team2GroupProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Team2GroupProjectDbContext, Task<T>> func)
        {
            T result;
