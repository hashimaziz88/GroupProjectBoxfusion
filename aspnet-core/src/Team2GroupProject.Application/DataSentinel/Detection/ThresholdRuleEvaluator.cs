...
{
    public class ThresholdRuleEvaluator : IThresholdRuleEvaluator, ITransientDependency
    {
        ...
        public async Task<ThresholdRuleEvaluationResultDto> EvaluateAsync(
            int tenantId,
            ...
            Guid? ruleId = null)
        {
            ...
            {
                rules = rules.Where(x => x.EventType == eventType.Value).ToList();
            }
